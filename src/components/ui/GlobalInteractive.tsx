...
// Only Sniper's Chennai HQ is marked now — the earlier demo markers (EU,
// Asia, LATAM, MENA, APAC) were placeholder points from the component's
// original multi-region demo and aren't real Sniper locations, so they're
// removed rather than hidden. `users` is kept on the type/marker (still
// shown if the label is ever expanded) but isn't meaningful data here;
// swap it for a real figure, or drop the "users" line in the label below,
// once there's an actual number to show.
const defaultMarkers: InteractiveMarker[] = [
  { id: "hq", location: [13.0827, 80.2707], name: "HQ", users: 1420 },
]
