...
<a href="index.html">
    <img src="img/download-1.png" style="height: 75px;" alt="Sniper System Logo">
</a>

<a class="navbar-brand">
    <img src="img/Apple_Biz_Partner_Logo.svg" alt="Apple Authorized Reseller" style="height: 45px; margin-left: 10px;">
</a>
                    ...
                    <div class="desktop-nav d-none d-lg-flex flex-grow-1 align-items-center justify-content-end">
                        <ul class="navbar-nav gap-2 align-items-center">
                            <li class="nav-item"><a class="nav-link" href="https://sniperindia.com/partners/apple/index.html">Home</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="has-submenu">
                                        ...
                                        <ul class="dropdown-menu submenu">
                                         <li><a class="dropdown-item" href="Macbook_Air_M5/index.html">MacBook Air M5</a></li>
                                            ...
                                            <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/iMac/index.html">iMac</a></li>
                                            <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/Mac-Mini/mac-mini.html">Mac mini</a></li>
                                            <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/Mac-Studio/max-studio.html">Mac Studio</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-submenu">
                                    ...
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/apple-care-plus.html">Apple Care +</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/apple-care-plus-enterprise.html">Apple Care for Enterprise</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/deployment-page.html">Deployment Services</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/lifecycle-management.html">Life Cycle Management</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/business-manager.html">Apple Business Manager</a></li>
                                    <li class="has-submenu">
                                        <a class="dropdown-item" href="#">Value Added Services</a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/service%20&%20deployment-bundles.html">Service & Deployment Bundles</a></li>
                                            <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/fusion-combos.html">Fusion Combo</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/start-up-program.html">Mac for Startups</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/switcher-program.html">Switch to Mac</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/developer-program.html">Mac for Developers</a></li>
                                    <li><a class="dropdown-item" href="https://sniperindia.com/partners/apple/refresh-program.html">Refresh Program</a></li>
                                </ul>
                            </li>

                            <li class="nav-item"><a class="nav-link" href="https://sniperindia.com/partners/apple/apple-smartEPP.html">Smart EPP</a></li>
    ...
    <img src="assets/images/Apple_logo.svg" alt="Apple Authorized Reseller" style="height: 45px;">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://sniperindia.com/partners/apple/apple-smartEPP.html">Smart EPP</a>
                        </li>
                        <li class="nav-item">
